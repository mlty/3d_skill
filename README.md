...
| **3D Printing** | STL | Manifold, wall thickness �?.2mm, correct physical size |
| **PowerPoint** | GLB | �?0K tris, �?0MB file, textures embedded |

## Chibi Figurine Workflow

Special interactive workflow for Q版手�?(chibi/blind box style):
...
Agent: 已知：what=柴犬, where=3D打印, style=Q�?
       默认高度 80mm，开始生�?3 张候选效果图...
...
**Pipeline:** Extract texture �?HSV classify (shadow-immune) �?select �? colors �?CIELAB assign �?quantized PNG �?Blender vertex colors �?Bambu filament match (43 colors, ΔE distance).
...
| Generation failed | Try different provider or more detailed prompt |
